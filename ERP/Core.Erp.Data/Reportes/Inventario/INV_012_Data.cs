...
namespace Core.Erp.Data.Reportes.Inventario
{
   public class INV_012_Data
    {
        public List<INV_012_Info> GetList(int IdEmpresa, int IdSucursal, int IdBodega, string tipo_movi, decimal IdNumMovi, DateTime FechaIni, DateTime FechaFin)
        {
            try
            {
                ...
                {
                    if ((tipo_movi == "" || tipo_movi == null) && (IdNumMovi==0))
                    {
                    ...
                    else if ((tipo_movi == "" || tipo_movi == null) && (IdNumMovi != 0))
                    {
                        Lista = Context.VWINV_012.Where(q =>
                        q.IdEmpresa == q.IdEmpresa
                        && IdSucursalIni <= q.IdSucursal
