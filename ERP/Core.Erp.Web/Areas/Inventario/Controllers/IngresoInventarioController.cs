...
namespace Core.Erp.Web.Areas.Inventario.Controllers
{
    ...
    public class IngresoInventarioController : Controller
    {
        ...
        in_Ingreso_Inven_List Lista_Ingreso = new in_Ingreso_Inven_List();
        ...
        public ActionResult Index()
        {
            ...
            #region Permisos
            seg_Menu_x_Empresa_x_Usuario_Info info = bus_permisos.get_list_menu_accion(Convert.ToInt32(SessionFixed.IdEmpresa), SessionFixed.IdUsuario, "Inventario", "IngresoInventario", "Index");
            ...
            var lst = bus_ing_inv.get_list(model.IdEmpresa, "+", model.IdSucursal, true, model.fecha_ini, model.fecha_fin);
            Lista_Ingreso.set_list(lst, model.IdTransaccionSession);
            return View(model);
        }
        ...
        [ValidateInput(false)]
        public ActionResult GridViewPartial_ingreso_inventario(bool Nuevo=false)
        {
            ViewBag.Nuevo = Nuevo;
            SessionFixed.IdTransaccionSessionActual = Request.Params["TransaccionFixed"] != null ? Request.Params["TransaccionFixed"].ToString() : SessionFixed.IdTransaccionSessionActual;
            var model = Lista_Ingreso.get_list(Convert.ToDecimal(SessionFixed.IdTransaccionSessionActual));
        ...
        {            
            ...
            in_Ing_Egr_Inven_Info model = new in_Ing_Egr_Inven_Info
            {
                ...
                IdMotivo_Inv = i_param.IdMotivo_Inv_ingreso
            };
        ...
        public ActionResult Nuevo(in_Ing_Egr_Inven_Info model)
        {
            ...
            return RedirectToAction("Consultar", new { IdEmpresa = model.IdEmpresa, IdSucursal = model.IdSucursal, IdMovi_inven_tipo = model.IdMovi_inven_tipo, IdNumMovi= model.IdNumMovi, Exito = true });
        }
        public ActionResult Consultar(int IdEmpresa = 0, int IdSucursal = 0, int IdMovi_inven_tipo = 0, decimal IdNumMovi = 0, bool Exito = false)
        {
            ...
            {
                if (model.Estado=="A" && model.IdEstadoAproba== "APRO")
                {
                    info.Modificar = false;
                }
            }
    ...
    public class in_Ingreso_Inven_List
    {
        string Variable = "in_Ingreso_Inven_Info";
