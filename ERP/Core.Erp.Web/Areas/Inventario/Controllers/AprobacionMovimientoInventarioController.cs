...
namespace Core.Erp.Web.Areas.Inventario.Controllers
{
    public class AprobacionMovimientoInventarioController : Controller
    {
        ...
        [ValidateInput(false)]
        public ActionResult GridViewPartial_movimiento_inventario_x_aprobar(DateTime? fecha_ini, DateTime? fecha_fin, int IdSucursal = 0)
        {
            ...
            List<in_Ing_Egr_Inven_Info> model = bus_ing_inv.get_list_x_aprobar(IdEmpresa, IdSucursal, true, ViewBag.fecha_ini, ViewBag.fecha_fin);
