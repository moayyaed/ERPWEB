...
namespace Core.Erp.Web.Areas.Inventario.Controllers
{
    ...
    public class EgresoInventarioController : Controller
    {
        ...
        public ActionResult CmbProducto_EgresoInventario()
      {
        ...
        {
            return bus_producto.get_list_bajo_demanda(args, Convert.ToInt32(SessionFixed.IdEmpresa),cl_enumeradores.eTipoBusquedaProducto.PORBODEGA,cl_enumeradores.eModulo.INV,0);
        }
