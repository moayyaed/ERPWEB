...
namespace Core.Erp.Web.Areas.Banco.Controllers
{
    ...
    public class NotaDeDebitoBancoController : Controller
    {
        ...
        ba_Cbte_Ban_List ListaNotaDebito = new ba_Cbte_Ban_List();
        ...
        public ActionResult Index()
        {
            ...
            #endregion
            #region Permisos
            seg_Menu_x_Empresa_x_Usuario_Info info = bus_permisos.get_list_menu_accion(Convert.ToInt32(SessionFixed.IdEmpresa), SessionFixed.IdUsuario, "Banco", "NotaDeDebitoBanco", "Index");
            ...
            var lst = bus_cbteban.get_list(model.IdEmpresa, model.fecha_ini, model.fecha_fin, model.IdSucursal, cl_enumeradores.eTipoCbteBancario.NDBA.ToString(), true);
            ListaNotaDebito.set_list(lst, model.IdTransaccionSession);
            return View(model);
        }
        [HttpPost]
        ...
        public ActionResult GridViewPartial_DebitoBanco(bool Nuevo=false)
        {
            //int IdEmpresa = Convert.ToInt32(SessionFixed.IdEmpresa);
