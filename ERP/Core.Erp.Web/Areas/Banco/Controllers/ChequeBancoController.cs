...
namespace Core.Erp.Web.Areas.Banco.Controllers
{
    ...
    public class ChequeBancoController : Controller
    {
        ...
        ba_Cbte_Ban_Cheque_List Lista_Cheque = new ba_Cbte_Ban_Cheque_List();
        ...
        public ActionResult Index()
        {
            ...
            #region Permisos
            seg_Menu_x_Empresa_x_Usuario_Info info = bus_permisos.get_list_menu_accion(Convert.ToInt32(SessionFixed.IdEmpresa), SessionFixed.IdUsuario, "Banco", "ChequeBanco", "Index");
        ...
        public ActionResult GridViewPartial_cheque(bool Nuevo=false)
        {
            //int IdEmpresa = Convert.ToInt32(SessionFixed.IdEmpresa);
            ...
            var model = Lista_Cheque.get_list(Convert.ToDecimal(SessionFixed.IdTransaccionSessionActual));
    ...
    public class ba_Cbte_Ban_Cheque_List
    {
        string Variable = "ba_Cbte_Ban_Cheque_Info";
