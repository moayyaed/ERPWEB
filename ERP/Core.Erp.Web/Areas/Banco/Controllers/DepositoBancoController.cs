...
namespace Core.Erp.Web.Areas.Banco.Controllers
{
    ...
    public class DepositoBancoController : Controller
    {
        ...
        ba_Cbte_Ban_Dep_List Lista_Deposito = new ba_Cbte_Ban_Dep_List();
        ...
        public ActionResult Index()
        {
            ...
            #region Permisos
            seg_Menu_x_Empresa_x_Usuario_Info info = bus_permisos.get_list_menu_accion(Convert.ToInt32(SessionFixed.IdEmpresa), SessionFixed.IdUsuario, "Banco", "DepositoBanco", "Index");
            ...
            var lst = bus_cbteban.get_list(model.IdEmpresa, model.fecha_ini, model.fecha_fin, model.IdSucursal, cl_enumeradores.eTipoCbteBancario.DEPO.ToString(), true);
            Lista_Deposito.set_list(lst, model.IdTransaccionSession);
        ...
        public ActionResult GridViewPartial_DepositoBanco(bool Nuevo=false)
        {
            //int IdEmpresa = Convert.ToInt32(SessionFixed.IdEmpresa);
            ...
            var model = Lista_Deposito.get_list(Convert.ToDecimal(SessionFixed.IdTransaccionSessionActual));
    ...
    public class ba_Cbte_Ban_Dep_List
    {
        string Variable = "ba_Cbte_Ban_Dep_Info";
