...
namespace Core.Erp.Web.Areas.Compras.Controllers
{
    ...
    public class OrdenCompraLocalController : Controller
    {
        ...
        com_ordencompra_local_List Lista_OrdenCompra = new com_ordencompra_local_List();
        ...
        {
            List<in_Producto_Info> Lista = bus_producto.get_list_bajo_demanda(args, Convert.ToInt32(SessionFixed.IdEmpresa), cl_enumeradores.eTipoBusquedaProducto.PORSUCURSAL, cl_enumeradores.eModulo.COM, Convert.ToInt32(SessionFixed.IdSucursal));
            return Lista;
        }
        ...
        public ActionResult Index()
        {
            ...
            #endregion
            #region Permisos
            seg_Menu_x_Empresa_x_Usuario_Info info = bus_permisos.get_list_menu_accion(Convert.ToInt32(SessionFixed.IdEmpresa), SessionFixed.IdUsuario, "Compras", "OrdenCompraLocal", "Index");
            ...
            Lista_OrdenCompra.set_list(lst, model.IdTransaccionSession);
        ...
        [ValidateInput(false)]
        public ActionResult GridViewPartial_ordencompralocal(bool Nuevo=false)
        {
            ...
            var model = Lista_OrdenCompra.get_list(Convert.ToDecimal(SessionFixed.IdTransaccionSessionActual));
    ...
    public class com_ordencompra_local_List
    {
