...
namespace Core.Erp.Web.Areas.RRHH.Controllers
{
    public class LiquidacionVacacionesController : Controller
    {
        ...
        public ActionResult Modificar(ro_Historico_Liquidacion_Vacaciones_Info info)
        {
            try
            {
                ...
                {
                    string mensaje = "";
                    info.lst_detalle = ro_Historico_Liquidacion_Vacaciones_Det_Info.get_list(info.IdTransaccionSession);
                    ...
                    {
                        return RedirectToAction("Modificar", new { IdEmpresa = info.IdEmpresa, IdSolicitud = info.IdSolicitud, Exito = true });
                    }
                }
                else
                    return View(info);
    ...
    public class ro_Historico_Liquidacion_Vacaciones_List
    {
        ...
        public List<ro_Historico_Liquidacion_Vacaciones_Info> get_list(decimal IdTransaccionSession)
        {
            ...
            return (List<ro_Historico_Liquidacion_Vacaciones_Info>)HttpContext.Current.Session[variable + IdTransaccionSession.ToString()];
        }
