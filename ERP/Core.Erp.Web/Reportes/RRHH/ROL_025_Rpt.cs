    ...
    public partial class ROL_025_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private void ROL_025_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
                ...
                int IdRol = p_IdRol.Value == null ? 0 : Convert.ToInt32(p_IdRol.Value);
                ...
                List<ROL_025_Info> lst_rpt = bus_rpt.get_list(IdEmpresa, IdSucursal, IdRol, IdNomina_Tipo, IdPeriodo);
                ...
                lbl_sucursal.Text = sucursal.Su_Descripcion;
