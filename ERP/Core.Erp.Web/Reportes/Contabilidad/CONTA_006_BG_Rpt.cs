...
{
    public partial class CONTA_006_BG_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private void CONTA_006_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            lst_rpt.AddRange(bus_rpt.GetList(IdEmpresa, mostrarSaldo0, IdUsuario, IdNivel, mostrarAcumulado, balance, FechaIni, FechaFin));
