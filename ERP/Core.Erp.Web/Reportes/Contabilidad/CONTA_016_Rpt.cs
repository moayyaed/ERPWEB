...
{
    public partial class  CONTA_016_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        public string usuario { get; set; }
        public string empresa { get; set; }

        public  CONTA_016_Rpt()
        {
            InitializeComponent();
        }

        private void  CONTA_016_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            CONTA_016_Bus bus_rpt = new  CONTA_016_Bus();
            List< CONTA_016_Info> lst_rpt = new List< CONTA_016_Info>();
