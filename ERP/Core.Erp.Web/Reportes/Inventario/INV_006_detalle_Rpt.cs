...
{
    public partial class INV_006_detalle_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        public string usuario { get; set; }
        public string empresa { get; set; }
        public INV_006_detalle_Rpt()
        {
            InitializeComponent();
        }

        private void INV_006_detalle_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
