...
{
    public partial class INV_005_resumen_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        public string usuario { get; set; }
        public string empresa { get; set; }
        public INV_005_resumen_Rpt()
        {
            InitializeComponent();
        }

        private void INV_005_resumen_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
