...
{
    public partial class INV_001_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private void VWINV_001_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            INV_001_Bus bus_rpt = new INV_001_Bus();
            List<INV_001_Info> lst_rpt = bus_rpt.get_list(IdEmpresa, IdSucursal, IdMovi_inven_tipo, IdNumMovi );
