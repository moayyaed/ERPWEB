...
namespace Core.Erp.Info.Reportes.Inventario
{
    public class INV_022_Info
    {
        ...
        public Nullable<double> CostoUltCompra { get; set; }
        public Nullable<double> CostoTotalUltCompra { get; set; }
        public Nullable<int> DiasEnInventario { get; set; }
        public Nullable<double> VariacionNIC { get; set; }
    }
}
