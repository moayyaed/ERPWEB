   ...
   public class cp_orden_giro_Bus
    {
        ...
        public List<cp_orden_giro_Info> get_lst(int IdEmpresa, int IdSucursal, DateTime fi, DateTime ff, bool MostrarDocumentosElectronicos, bool FiltrarPorFechaContabilizacion)
        {
            try
            {
                return data.get_lst(IdEmpresa, IdSucursal, fi, ff, MostrarDocumentosElectronicos, FiltrarPorFechaContabilizacion);
            }
            catch (Exception)
            {
        ...
        public List<cp_orden_giro_Info> get_lst_orden_giro_x_pagar(int IdEmpresa, int IdSucursal)
        {
            try
            {
                return data.get_lst_orden_giro_x_pagar(IdEmpresa, IdSucursal);
            }
            catch (Exception)
            {
