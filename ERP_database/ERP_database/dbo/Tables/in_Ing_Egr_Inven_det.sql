CREATE TABLE [dbo].[in_Ing_Egr_Inven_det] (
    ...
    CONSTRAINT [FK_in_Ing_Egr_Inven_det_ct_CentroCosto] FOREIGN KEY ([IdEmpresa], [IdCentroCosto]) REFERENCES [dbo].[ct_CentroCosto] ([IdEmpresa], [IdCentroCosto]),
    ...
    CONSTRAINT [FK_in_Ing_Egr_Inven_det_ct_punto_cargo_grupo] FOREIGN KEY ([IdEmpresa], [IdPunto_cargo_grupo]) REFERENCES [dbo].[ct_punto_cargo_grupo] ([IdEmpresa], [IdPunto_cargo_grupo]),
