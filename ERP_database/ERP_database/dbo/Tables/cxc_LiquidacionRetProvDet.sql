CREATE TABLE [dbo].[cxc_LiquidacionRetProvDet] (
    ...
    CONSTRAINT [PK_cxc_LiquidacionRetProvDet] PRIMARY KEY CLUSTERED ([IdEmpresa] ASC, [IdLiquidacion] ASC, [Secuencia] ASC),
    ...
    CONSTRAINT [FK_cxc_LiquidacionRetProvDet_cxc_LiquidacionRetProv] FOREIGN KEY ([IdEmpresa], [IdLiquidacion]) REFERENCES [dbo].[cxc_LiquidacionRetProv] ([IdEmpresa], [IdLiquidacion])
);
