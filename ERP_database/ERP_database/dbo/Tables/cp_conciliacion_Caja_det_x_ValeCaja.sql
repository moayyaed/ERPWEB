CREATE TABLE [dbo].[cp_conciliacion_Caja_det_x_ValeCaja] (
	...
	CONSTRAINT [FK_cp_conciliacion_Caja_det_x_ValeCaja_ct_CentroCosto] FOREIGN KEY ([IdEmpresa], [IdCentroCosto]) REFERENCES [dbo].[ct_CentroCosto] ([IdEmpresa], [IdCentroCosto])
);
