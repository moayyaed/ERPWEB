CREATE TABLE [dbo].[ct_plancta] (
    ...
    CONSTRAINT [FK_ct_plancta_ct_ClasificacionEBIT] FOREIGN KEY ([IdClasificacionEBIT]) REFERENCES [dbo].[ct_ClasificacionEBIT] ([IdClasificacionEBIT]),
