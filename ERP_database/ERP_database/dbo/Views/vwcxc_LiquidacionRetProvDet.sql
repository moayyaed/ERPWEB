CREATE VIEW vwcxc_LiquidacionRetProvDet
AS
...
FROM            cxc_cobro_tipo INNER JOIN
                         ...
                         cxc_cobro_tipo_Param_conta_x_sucursal.IdCtaCble = ct_plancta.IdCtaCble INNER JOIN
...
WHERE        (cxc_cobro.cr_estado = N'A') AND (cxc_cobro.cr_EsProvision = 1)