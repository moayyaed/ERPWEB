...
AS
SELECT dbo.ro_rol_detalle.IdEmpresa, dbo.ro_rol_detalle.IdRol, dbo.ro_rol_detalle.IdEmpleado, dbo.ro_rol_detalle.IdRubro, CAST(dbo.ro_rol_detalle.Valor AS numeric(10, 2)) AS Valor, dbo.ro_rol_detalle.IdSucursal, dbo.ro_empleado.em_codigo, 
...
WHERE  (dbo.ro_rol_detalle.IdRubro = 24) AND (CAST(dbo.ro_rol_detalle.Valor AS numeric(10, 1)) <= 0) and dbo.ro_empleado.em_estado = 'A'
GO
