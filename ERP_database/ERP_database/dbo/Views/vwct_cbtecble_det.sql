...
SELECT        dbo.ct_cbtecble_det.IdEmpresa, dbo.ct_cbtecble_det.IdTipoCbte, dbo.ct_cbtecble_det.IdCbteCble, dbo.ct_cbtecble_det.secuencia, dbo.ct_cbtecble_det.IdCtaCble, dbo.ct_cbtecble_det.dc_Valor, 
                         dbo.ct_cbtecble_det.dc_Observacion, dbo.ct_cbtecble_det.dc_para_conciliar, dbo.ct_cbtecble_det.IdCtaCble + ' - ' + dbo.ct_plancta.pc_Cuenta AS pc_Cuenta, dbo.ct_cbtecble_det.IdPunto_cargo_grupo, 
                         dbo.ct_cbtecble_det.IdPunto_cargo, dbo.ct_cbtecble_det.IdCentroCosto
