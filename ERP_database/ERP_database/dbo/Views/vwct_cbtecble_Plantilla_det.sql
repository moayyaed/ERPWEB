CREATE view vwct_cbtecble_Plantilla_det as
SELECT dbo.ct_cbtecble_Plantilla_det.IdEmpresa, dbo.ct_cbtecble_Plantilla_det.IdPlantilla, dbo.ct_cbtecble_Plantilla_det.secuencia, dbo.ct_cbtecble_Plantilla_det.IdCtaCble, dbo.ct_cbtecble_Plantilla_det.dc_Valor, 
                  dbo.ct_cbtecble_Plantilla_det.dc_Observacion, dbo.ct_cbtecble_Plantilla_det.IdPunto_cargo_grupo, dbo.ct_cbtecble_Plantilla_det.IdPunto_cargo, dbo.ct_cbtecble_Plantilla_det.IdCentroCosto, dbo.ct_plancta.pc_Cuenta, 
                  dbo.ct_CentroCosto.cc_Descripcion, dbo.ct_punto_cargo.nom_punto_cargo
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vwct_cbtecble_Plantilla_det';
