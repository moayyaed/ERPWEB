...
AS
SELECT dbo.ct_cbtecble_det.IdEmpresa, dbo.ct_cbtecble_det.IdTipoCbte, dbo.ct_cbtecble_det.IdCbteCble, dbo.ct_cbtecble_det.secuencia, ncnd.cn_fecha, ncnd.cn_Fecha_vcto, dbo.ct_cbtecble.cb_Observacion, ncnd.Estado, 
                  ncnd.cn_subtotal_iva, ncnd.cn_subtotal_siniva, ncnd.cn_valoriva, ncnd.cn_total, dbo.ct_cbtecble_det.IdCtaCble, dbo.ct_plancta.pc_Cuenta, dbo.ct_cbtecble_det.dc_Valor, 
                  CASE WHEN ct_cbtecble_det.dc_Valor > 0 THEN ABS(ct_cbtecble_det.dc_Valor) ELSE 0 END AS dc_Valor_Debe, CASE WHEN ct_cbtecble_det.dc_Valor < 0 THEN ABS(ct_cbtecble_det.dc_Valor) 
                  ELSE 0 END AS dc_Valor_Haber, dbo.ct_cbtecble_tipo.tc_TipoCbte, dbo.ct_cbtecble_det.dc_Observacion, ncnd.IdProveedor, per.pe_nombreCompleto, ncnd.DebCre, 
                  CASE WHEN ncnd.DebCre = 'C' THEN 'Crédito' ELSE 'Débito' END AS Tipo_doc, ncnd.cn_Nota AS num_documento, dbo.tb_sucursal.Su_Descripcion, dbo.cp_catalogo.Nombre AS NomTipoNota, 
                  dbo.ct_CentroCosto.cc_Descripcion, dbo.ct_punto_cargo_grupo.nom_punto_cargo_grupo, dbo.ct_punto_cargo.nom_punto_cargo
FROM     dbo.ct_punto_cargo_grupo INNER JOIN
                  ...
                  dbo.cp_catalogo ON ncnd.IdTipoNota = dbo.cp_catalogo.IdCatalogo LEFT OUTER JOIN
                  dbo.ct_CentroCosto ON dbo.ct_cbtecble_det.IdEmpresa = dbo.ct_CentroCosto.IdEmpresa AND dbo.ct_cbtecble_det.IdCentroCosto = dbo.ct_CentroCosto.IdCentroCosto ON 
                  dbo.ct_punto_cargo.IdEmpresa = dbo.ct_cbtecble_det.IdEmpresa AND dbo.ct_punto_cargo.IdPunto_cargo = dbo.ct_cbtecble_det.IdPunto_cargo
...
Begin DesignProperties = 
   Begin PaneConfigurations = 
      Begin PaneConfiguration = 0
         NumPanes = 4
         Configuration = "(H (1[53] 4[5] 2[9] 3) )"
      End
