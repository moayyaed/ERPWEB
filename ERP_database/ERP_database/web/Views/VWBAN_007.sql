...
AS
SELECT ISNULL(ROW_NUMBER() OVER (ORDER BY dbo.ba_Cbte_Ban.IdEmpresa), 0) AS IdRow, dbo.ba_Cbte_Ban.IdEmpresa, dbo.ba_Cbte_Ban.IdCbteCble, dbo.ba_Cbte_Ban.IdTipocbte, ISNULL(ba_Cbte_Ban.cb_FechaCheque,ba_Cbte_Ban.cb_Fecha) cb_FechaCheque, 
ISNULL(ba_Cbte_Ban.cb_FechaCheque,ba_Cbte_Ban.cb_Fecha) cb_Cheque, dbo.tb_persona.pe_nombreCompleto, dbo.ba_Cbte_Ban.cb_Valor, dbo.ba_Catalogo.ca_descripcion, dbo.ba_Cbte_Ban.cb_Fecha, dbo.seg_usuario.Nombre, dbo.ba_Cbte_Ban.cb_Observacion, 
