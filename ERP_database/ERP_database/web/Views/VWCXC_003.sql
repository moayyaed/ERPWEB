...
SELECT dbo.fa_factura.IdEmpresa, dbo.fa_factura.IdSucursal, dbo.fa_factura.IdBodega, dbo.fa_factura.IdCbteVta, dbo.fa_factura.vt_serie1 + '-' + dbo.fa_factura.vt_serie2 + '-' + dbo.fa_factura.vt_NumFactura AS vt_NumFactura, 
                  ...
                  dbo.cxc_cobro_tipo.PorcentajeRet, CASE WHEN cxc_cobro_tipo.ESRetenFTE = 'S' THEN fa_factura_resumen.SubtotalConDscto WHEN cxc_cobro_tipo.ESRetenIVA = 'S' THEN fa_factura_resumen.ValorIVA ELSE 0 END AS Base, 
                  ...
                  THEN 'COMPROBANTE SIN RETENCION' WHEN cxc_cobro_tipo.ESRetenFTE = 'S' THEN 'RETENCION DE FUENTE' WHEN cxc_cobro_tipo.ESRetenIVA = 'S' THEN 'RETENCION DE IVA' END AS TipoRetencion, dbo.fa_factura.IdCliente, 
                  dbo.fa_factura.vt_fecha, dbo.cxc_cobro_det.dc_ValorPago
FROM     dbo.fa_cliente INNER JOIN
                  ...
                  dbo.cxc_cobro_det ON dbo.cxc_cobro_tipo.IdCobro_tipo = dbo.cxc_cobro_det.IdCobro_tipo AND dbo.cxc_cobro_det.estado = 'A' and (ISNULL(dbo.cxc_cobro_tipo.IdMotivo_tipo_cobro, 'RET') = 'RET')INNER JOIN
                  ...
                  dbo.cxc_cobro.cr_estado <> 'I' ON dbo.fa_factura.IdEmpresa = dbo.cxc_cobro_det.IdEmpresa AND dbo.fa_factura.IdSucursal = dbo.cxc_cobro_det.IdSucursal AND dbo.fa_factura.IdBodega = dbo.cxc_cobro_det.IdBodega_Cbte AND 
...
WHERE  (dbo.fa_factura.Estado = 'A') --and vt_NumFactura = 13595
GO
