...
SELECT dbo.fa_notaCreDeb_det.IdEmpresa, dbo.fa_notaCreDeb_det.IdSucursal, dbo.fa_notaCreDeb_det.IdBodega, dbo.fa_notaCreDeb_det.IdNota, dbo.fa_notaCreDeb.CodDocumentoTipo, ISNULL(SUM(dbo.fa_notaCreDeb_det.sc_subtotal), 0) 
				  ...
				  dbo.tb_sucursal.Su_Descripcion, dbo.fa_cliente.IdCliente, CASE WHEN RET.IdEmpresa IS NULL 
                  THEN CAST(0 AS BIT) ELSE CAST(1 AS BIT) END AS TieneRetencion
...
GROUP BY dbo.fa_notaCreDeb_det.IdEmpresa, dbo.fa_notaCreDeb_det.IdSucursal, dbo.fa_notaCreDeb_det.IdBodega, dbo.fa_notaCreDeb_det.IdNota, dbo.fa_notaCreDeb.CodDocumentoTipo, dbo.tb_persona.pe_nombreCompleto, 
                  dbo.fa_notaCreDeb.no_fecha, dbo.fa_notaCreDeb.no_fecha_venc, dbo.fa_notaCreDeb.sc_observacion, dbo.fa_notaCreDeb.CodNota, dbo.fa_notaCreDeb.Serie1,dbo.fa_notaCreDeb.Serie2,dbo.fa_notaCreDeb.IdNota,dbo.fa_notaCreDeb.NaturalezaNota, dbo.fa_notaCreDeb.NumNota_Impresa, dbo.tb_sucursal.Su_Descripcion, dbo.fa_cliente.IdCliente, 
                  RET.IdEmpresa