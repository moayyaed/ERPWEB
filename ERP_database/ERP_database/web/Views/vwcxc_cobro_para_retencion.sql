...
FROM     dbo.fa_factura INNER JOIN
                  ...
                  tb_persona ON fa_cliente.IdPersona = tb_persona.IdPersona LEFT JOIN
                      (SELECT dbo.cxc_cobro_det.IdEmpresa, dbo.cxc_cobro_det.IdSucursal, dbo.cxc_cobro_det.IdBodega_Cbte, dbo.cxc_cobro_det.IdCbte_vta_nota, dbo.cxc_cobro_det.dc_TipoDocumento, dbo.cxc_cobro_tipo.IdMotivo_tipo_cobro, cr_EsElectronico
                       ...
                       GROUP BY dbo.cxc_cobro_det.IdEmpresa, dbo.cxc_cobro_det.IdSucursal, dbo.cxc_cobro_det.IdBodega_Cbte, dbo.cxc_cobro_det.IdCbte_vta_nota, dbo.cxc_cobro_det.dc_TipoDocumento, dbo.cxc_cobro_tipo.IdMotivo_tipo_cobro, cr_EsElectronico) 
                  AS RET ON fa_factura.IdEmpresa = RET.IdEmpresa AND fa_factura.IdSucursal = RET.IdSucursal AND fa_factura.IdBodega = RET.IdBodega_Cbte AND fa_factura.IdCbteVta = RET.IdCbte_vta_nota AND 
...
FROM     dbo.fa_notaCreDeb INNER JOIN
                  ...
                  dbo.tb_sucursal ON dbo.fa_notaCreDeb_det.IdEmpresa = dbo.tb_sucursal.IdEmpresa AND dbo.fa_notaCreDeb_det.IdSucursal = dbo.tb_sucursal.IdSucursal LEFT JOIN
                      (SELECT dbo.cxc_cobro_det.IdEmpresa, dbo.cxc_cobro_det.IdSucursal, dbo.cxc_cobro_det.IdBodega_Cbte, dbo.cxc_cobro_det.IdCbte_vta_nota, dbo.cxc_cobro_det.dc_TipoDocumento, dbo.cxc_cobro_tipo.IdMotivo_tipo_cobro, cxc_cobro.cr_EsElectronico
                       FROM      dbo.cxc_cobro INNER JOIN
                                         dbo.cxc_cobro_det ON dbo.cxc_cobro.IdEmpresa = dbo.cxc_cobro_det.IdEmpresa AND dbo.cxc_cobro.IdSucursal = dbo.cxc_cobro_det.IdSucursal AND dbo.cxc_cobro.IdCobro = dbo.cxc_cobro_det.IdCobro INNER JOIN
                                         dbo.cxc_cobro_tipo ON dbo.cxc_cobro_det.IdCobro_tipo = dbo.cxc_cobro_tipo.IdCobro_tipo
                       WHERE   (dbo.cxc_cobro_tipo.IdMotivo_tipo_cobro = 'RET') AND (dbo.cxc_cobro_det.estado = 'A') AND (dbo.cxc_cobro.cr_estado = N'A')
                       GROUP BY dbo.cxc_cobro_det.IdEmpresa, dbo.cxc_cobro_det.IdSucursal, dbo.cxc_cobro_det.IdBodega_Cbte, dbo.cxc_cobro_det.IdCbte_vta_nota, dbo.cxc_cobro_det.dc_TipoDocumento, dbo.cxc_cobro_tipo.IdMotivo_tipo_cobro,cr_EsElectronico) 
                  AS RET ON fa_notaCreDeb.IdEmpresa = RET.IdEmpresa AND fa_notaCreDeb.IdSucursal = RET.IdSucursal AND fa_notaCreDeb.IdBodega = RET.IdBodega_Cbte AND fa_notaCreDeb.IdNota = RET.IdCbte_vta_nota AND 
                  fa_notaCreDeb.CodDocumentoTipo = RET.dc_TipoDocumento
...
GROUP BY dbo.fa_notaCreDeb_det.IdEmpresa, dbo.fa_notaCreDeb_det.IdSucursal, dbo.fa_notaCreDeb_det.IdBodega, dbo.fa_notaCreDeb_det.IdNota, dbo.fa_notaCreDeb.CodDocumentoTipo, dbo.tb_persona.pe_nombreCompleto, 
                  ...
                  dbo.fa_notaCreDeb.NaturalezaNota, dbo.fa_notaCreDeb.NumNota_Impresa, dbo.tb_sucursal.Su_Descripcion, dbo.fa_cliente.IdCliente, RET.IdEmpresa,cr_EsElectronico