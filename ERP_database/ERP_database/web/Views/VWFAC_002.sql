...
FROM     dbo.fa_notaCreDeb INNER JOIN
                  ...
                  dbo.fa_cliente_contactos ON dbo.fa_notaCreDeb.IdContacto = dbo.fa_cliente_contactos.IdContacto AND dbo.fa_notaCreDeb.IdCliente = dbo.fa_cliente_contactos.IdCliente AND 
