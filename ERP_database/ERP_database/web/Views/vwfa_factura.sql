...
SELECT dbo.fa_factura.IdEmpresa, dbo.fa_factura.IdSucursal, dbo.fa_factura.IdBodega, dbo.fa_factura.IdCbteVta, dbo.fa_factura.vt_NumFactura, dbo.fa_factura.vt_fecha, dbo.tb_persona.pe_nombreCompleto AS Nombres, 
                  ...
                  dbo.fa_factura.vt_autorizacion, dbo.fa_factura.CodCbteVta
FROM     dbo.fa_factura INNER JOIN
                  ...
                  dbo.fa_cliente_contactos ON dbo.fa_factura.IdContacto = dbo.fa_cliente_contactos.IdContacto AND dbo.fa_factura.IdEmpresa = dbo.fa_cliente_contactos.IdEmpresa AND 
                  dbo.fa_factura.IdCliente = dbo.fa_cliente_contactos.IdCliente LEFT OUTER JOIN
