...
SELECT dbo.fa_factura_x_fa_guia_remision.fa_IdEmpresa, dbo.fa_factura_x_fa_guia_remision.fa_IdSucursal, dbo.fa_factura_x_fa_guia_remision.fa_IdBodega, dbo.fa_factura_x_fa_guia_remision.fa_IdCbteVta, 
                  dbo.fa_guia_remision.IdEmpresa AS gi_IdEmpresa, dbo.fa_guia_remision.IdSucursal AS gi_IdSucursal, dbo.fa_guia_remision.IdBodega AS gi_IdBodega, dbo.fa_guia_remision.IdGuiaRemision AS gi_IdGuiaRemision, 
                  dbo.fa_guia_remision_det.Secuencia, dbo.fa_guia_remision_det.IdProducto, dbo.in_Producto.pr_codigo, dbo.in_Producto.pr_descripcion, dbo.fa_guia_remision_det.gi_cantidad, 
                  dbo.fa_guia_remision_det.gi_detallexItems, dbo.tb_persona.pe_nombreCompleto, dbo.tb_persona.pe_cedulaRuc, dbo.fa_guia_remision.CodDocumentoTipo, 
                  dbo.fa_guia_remision.Serie1 + '-' + dbo.fa_guia_remision.Serie2 + '-' + dbo.fa_guia_remision.NumGuia_Preimpresa AS NumGuia_Preimpresa, dbo.fa_guia_remision.CodGuiaRemision, 
                  dbo.fa_guia_remision.NUAutorizacion, dbo.fa_guia_remision.Fecha_Autorizacion, dbo.fa_guia_remision.IdCliente, dbo.fa_guia_remision.IdTransportista, dbo.fa_guia_remision.gi_fecha, 
                  dbo.fa_guia_remision.gi_FechaFinTraslado, dbo.fa_guia_remision.gi_FechaInicioTraslado, dbo.fa_guia_remision.gi_Observacion, dbo.fa_guia_remision.placa, dbo.fa_guia_remision.Direccion_Origen, 
                  dbo.fa_guia_remision.Direccion_Destino, dbo.fa_guia_remision.Estado, dbo.fa_MotivoTraslado.tr_Descripcion, 
                  dbo.fa_factura.vt_serie1 + '-' + dbo.fa_factura.vt_serie2 + '' + dbo.fa_factura.vt_NumFactura AS NumComprobanteVenta, dbo.tb_transportista.Cedula AS CedulaTransportista, 
                  dbo.tb_transportista.Nombre AS NombreTransportista, dbo.fa_factura.vt_fecha, dbo.fa_factura.vt_autorizacion, dbo.tb_sucursal.Su_Descripcion, dbo.tb_sucursal.Su_Direccion
FROM     dbo.tb_sucursal INNER JOIN
                  ...
                  dbo.in_Producto ON dbo.fa_guia_remision_det.IdEmpresa = dbo.in_Producto.IdEmpresa AND dbo.fa_guia_remision_det.IdProducto = dbo.in_Producto.IdProducto ON 
                  dbo.tb_sucursal.IdEmpresa = dbo.fa_guia_remision.IdEmpresa AND dbo.tb_sucursal.IdSucursal = dbo.fa_guia_remision.IdSucursal LEFT OUTER JOIN
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N'ight = 293
            End
            DisplayFlags = 280
            TopColumn = 0
         End
...
Begin DesignProperties = 
   Begin PaneConfigurations = 
      Begin PaneConfiguration = 0
         NumPanes = 4
         Configuration = "(H (1[25] 4[25] 3[22] 2) )"
      End
      ...
      Begin Tables = 
         ...
         Begin Table = "fa_MotivoTraslado"
            Begin Extent = 
               ...
               Left = 48
               Bottom = 1346
               R', @level0type = N'SCHEMA', @level0name = N'web', @level1type = N'VIEW', @level1name = N'VWFAC_020';
