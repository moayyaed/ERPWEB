...
FROM     dbo.ct_punto_cargo RIGHT OUTER JOIN
                  ...
                  dbo.tb_persona ON dbo.caj_Caja_Movimiento.IdPersona = dbo.tb_persona.IdPersona ON dbo.ct_punto_cargo.IdEmpresa = dbo.ct_cbtecble_det.IdEmpresa AND 
                  dbo.ct_punto_cargo.IdPunto_cargo = dbo.ct_cbtecble_det.IdPunto_cargo LEFT OUTER JOIN
                  dbo.ct_punto_cargo_grupo ON dbo.ct_punto_cargo.IdEmpresa = dbo.ct_punto_cargo_grupo.IdEmpresa AND dbo.ct_punto_cargo.IdPunto_cargo_grupo = dbo.ct_punto_cargo_grupo.IdPunto_cargo_grupo LEFT OUTER JOIN
                  ...
                  dbo.ct_cbtecble ON dbo.tb_sucursal.IdEmpresa = dbo.ct_cbtecble.IdEmpresa AND dbo.tb_sucursal.IdSucursal = dbo.ct_cbtecble.IdSucursal ON dbo.caj_Caja_Movimiento.IdEmpresa = dbo.ct_cbtecble.IdEmpresa AND 
                  dbo.caj_Caja_Movimiento.IdTipocbte = dbo.ct_cbtecble.IdTipoCbte AND dbo.caj_Caja_Movimiento.IdCbteCble = dbo.ct_cbtecble.IdCbteCble LEFT OUTER JOIN
...
Begin DesignProperties = 
   Begin PaneConfigurations = 
      Begin PaneConfiguration = 0
         NumPanes = 4
         Configuration = "(H (1[37] 4[5] 2[40] 3) )"
      End
      ...
      Begin Tables = 
         ...
         Begin Table = "ct_plancta"
            Begin Extent = 
               ...
               Left = 48
               Bottom = 842
               Right =', @level0type = N'SCHEMA', @level0name = N'web', @level1type = N'VIEW', @level1name = N'VWCAJ_001';
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N' 259
            End
            DisplayFlags = 280
            TopColumn = 1
         End
