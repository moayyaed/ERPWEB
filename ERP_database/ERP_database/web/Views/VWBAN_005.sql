...
SELECT dbo.ba_Cbte_Ban.IdEmpresa, dbo.ba_Cbte_Ban.IdTipocbte, dbo.ba_Cbte_Ban.IdCbteCble, dbo.ba_Cbte_Ban.cb_giradoA, dbo.ba_Cbte_Ban.ValorEnLetras, dbo.tb_ciudad.Descripcion_Ciudad, dbo.ba_Cbte_Ban.cb_Valor, 
                  ISNULL(dbo.ba_Cbte_Ban.cb_FechaCheque, dbo.ba_Cbte_Ban.cb_Fecha) cb_Fecha, dbo.ba_Cbte_Ban.cb_Cheque, CAST(dbo.ba_Cbte_Ban.cb_Cheque AS numeric) AS cb_Cheque_numero, dbo.ba_Cbte_Ban.Estado, dbo.ba_Cbte_Ban.IdBanco, dbo.ba_Cbte_Ban.cb_Observacion, 
