...
SELECT dbo.cxc_cobro_det.IdEmpresa, dbo.cxc_cobro_det.IdSucursal, dbo.cxc_cobro_det.IdCobro, dbo.cxc_cobro_det.secuencial, dbo.cxc_cobro_det.IdBodega_Cbte, dbo.cxc_cobro_det.IdCbte_vta_nota, dbo.cxc_cobro_det.dc_TipoDocumento, 
                  ...
                  dbo.tb_persona.pe_cedulaRuc, dbo.cxc_cobro.cr_estado, dbo.tb_sucursal.Su_Descripcion, CASE WHEN cxc_cobro.IdCobro_tipo = 'DEPO' THEN ba_Banco_Cuenta.ba_descripcion ELSE
				  dbo.cxc_cobro.cr_Banco END  AS ba_descripcion, dbo.cxc_cobro.cr_NumDocumento, dbo.cxc_cobro.cr_TotalCobro, dbo.seg_usuario.Nombre, 
...
SELECT dbo.cxc_cobro_det.IdEmpresa, dbo.cxc_cobro_det.IdSucursal, dbo.cxc_cobro_det.IdCobro, dbo.cxc_cobro_det.secuencial, dbo.cxc_cobro_det.IdBodega_Cbte, dbo.cxc_cobro_det.IdCbte_vta_nota, dbo.cxc_cobro_det.dc_TipoDocumento, 
				  ...
				  CASE WHEN cxc_cobro.IdCobro_tipo = 'DEPO' THEN ba_Banco_Cuenta.ba_descripcion ELSE
				  dbo.cxc_cobro.cr_Banco END AS ba_descripcion
