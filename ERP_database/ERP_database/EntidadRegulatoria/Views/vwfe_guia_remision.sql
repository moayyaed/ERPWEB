...
SELECT        dbo.fa_guia_remision.IdEmpresa, dbo.fa_guia_remision.IdSucursal, dbo.fa_guia_remision.IdBodega, dbo.fa_guia_remision.IdGuiaRemision, dbo.fa_guia_remision.CodGuiaRemision, 
                         ...
                         dbo.fa_guia_remision.Direccion_Destino, dbo.tb_transportista.Cedula, dbo.tb_transportista.Nombre, dbo.tb_persona.pe_nombreCompleto AS Nombres, dbo.fa_cliente_contactos.Telefono, 
                         dbo.fa_cliente_contactos.Celular, dbo.fa_cliente_contactos.Correo, dbo.fa_guia_remision.Direccion_Destino AS Direccion, dbo.tb_persona.pe_cedulaRuc, dbo.tb_persona.pe_nombreCompleto, 
                         dbo.tb_persona.IdTipoDocumento, dbo.tb_persona.pe_Naturaleza, dbo.tb_empresa.em_nombre, dbo.tb_empresa.RazonSocial, dbo.tb_empresa.NombreComercial, dbo.tb_empresa.em_ruc, 
                         dbo.tb_empresa.em_telefonos, dbo.tb_empresa.ContribuyenteEspecial, 'SI' AS ObligadoAllevarConta, dbo.tb_empresa.em_Email, dbo.tb_empresa.em_direccion, dbo.fa_factura.vt_serie1, 
                         dbo.fa_factura.vt_serie2, dbo.fa_factura.vt_NumFactura, dbo.fa_factura.vt_fecha, dbo.fa_MotivoTraslado.tr_Descripcion + ' - ' + ISNULL(dbo.fa_guia_remision.gi_Observacion, '') AS tr_Descripcion
      ...
      Begin Tables = 
         ...
         Begin Table = "tb_empresa"
            Begin Extent = 
               ...
               Left = 712
               Bottom = 588
               Right = 931', @level0type = N'SCHEMA', @level0name = N'EntidadRegulatoria', @level1type = N'VIEW', @level1name = N'vwfe_guia_remision';
