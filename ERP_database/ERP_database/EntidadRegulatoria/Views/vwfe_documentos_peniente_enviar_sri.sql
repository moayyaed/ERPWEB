...
union all
select IdEmpresa,IdSucursal,IdBodega,IdGuiaRemision,'GUIA' TipoDocumento, Fecha_Transac, gi_fecha from fa_guia_remision where aprobada_enviar_sri=1 and Generado is null
union all
